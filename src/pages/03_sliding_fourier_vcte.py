...
#--------------------------------register-----------------------------
register_page(__name__, path="/sliding-fourier-Vcte",
              name = "Sliding Fourier constant V")
#---------------------------------------------------------------------
...
x_cte_data = {'x':B,'xname':'B','sec':V,'secname':'V','r':r}

typedic = {'type':'vcte-fourier-sliding'} #type associate to page vcte fourier
#----------------------------------------------------------------
#-------- buttons Col -----------------------------------------
